...
// Blue <-> White <-> Blue
led_setup_t leds_blue_white_blue[] = {
    { .hs = 0,  .he = 50,  .rs = 0,   .re = 255, .gs = 0,   .ge = 255, .bs = 255, .be = 255, .ef = EF_OVER },
    { .hs = 50, .he = 100, .rs = 255, .re = 0,   .gs = 255, .ge = 0,   .bs = 255, .be = 255, .ef = EF_OVER },
    { .end = 1 },
};
